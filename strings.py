    ...
    def InitAsEnglish(self):
        ...
        self.strings = {
            ...
            'EntranceDataEditor': {
                ...
                12: 'Verbundene Röhre (Funktioniert nicht)',
                ...
                18: 'Links zur Vorwärtsröhre (Funktioniert nicht)',
                ...
                28: '([id]) [name]',
                29: '[b]Players to spawn:[/b][br]Spieler Spawn an diesem Eingang. Funktioniert nur mit den Eingangstypen 25 und 34',
            ...
            'MenuItems': {
                ...
                146: 'Aufstieg nach oben',
                147: 'Hebe die ausgewählten Objekte in den Vordergrund aller anderen Objekte in dem Bereich.',
                148: 'Nach Unten',
                149: 'Ausgewählte Objekte hinter alle anderen Objekte in dem Bereich absenken.',
                },
            'Objects': {
            ...
            'ZonesDlg': {
                ...
                39: 'Kamera-Tracking:',
                40: '[b]Kamera-Tracking:[/b][br]Diese Einstellung ändert die Kameraführung während des Mehrspielermodus.[br]Diese Einstellung ändert die Kameraführung während des Mehrspielermodus.[br]Es priorisiert die Richtungen, wenn Spieler in die falsche Richtung gehen.[br]Wenn du z.B. ein Turm-Level machst, bei dem das Hauptziel es ist, nach oben zu gehen[br]und du nicht möchtest, dass der Bildschirm wieder nach unten geht, wenn nur ein Spieler fällt,[br]dann stelle die Verfolgung auf einen Wert ein, der \'Oben\' enthält und das verhindert, dass das passiert.',
                41: (
                    'Versteckt',
                    'Oben',
                    ),
                ...
                77: (
                    'Vergrößert beginnen:',
                    'Zentrierte Kamera X-Pos beim Laden:',
                    'Kamera folgt auf der Y-Achse:',
                    'Kamera stoppt am Zonenende:',
                    'Unbenutzt 1:',
                    'Toad Haus bezogen 1:',
                    'Unbenutzt 2:',
                    'Toad Haus bezogen 2:',
                ...
                80: 'Licht mit kleinem Fokus',
                81: '[b]Sichtbarkeit:[/b][br]Klein - Ein kleiner, zentrierter Scheinwerfer bietet Sichtbarkeit durch Ebene 0.[br]Kleiner Scheinwerfer - Ein kleiner Scheinwerfer, der je nach Bewegung des Spielers seine Größe verändert.',
                },
            'Zones': {
                0: 'Zone [num]',
